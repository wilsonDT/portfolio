...
- Homepage scope (2026-09-06): short, about four screens. Hero with a logo strip of every employer including internships, an About scene, two featured public engagements with one public figure each, side projects, after hours, end credits. Everything else is a bullet under the role on /experience. Refined the same day (docs/superpowers/specs/2026-09-06-quiet-cut-design.md): no section numbers or numbered slates, an About scene (paragraph, experience link, three resume figures) sits between the hero and Work, scenes open with a hairline and a serif title, cards are frame, title, one line, one number and a link, no arrow glyphs on links. Wilson found the numbered labels and arrows generic; do not reintroduce them. The nav (2026-09-06, docs/superpowers/specs/2026-09-06-frosted-nav-design.md) is a sticky bar that frosts once scrolled, hides on scroll down and returns on scroll up, and lights the current scene; frames break out to 960px while the text column stays at 620px. A sidebar and a bottom pill were considered and rejected.
