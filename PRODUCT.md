...
- Homepage scope (2026-09-06): short, about three screens. Hero with a logo strip of every employer including internships, two featured public engagements with one public figure each, side projects, after hours, end credits. Everything else is a bullet under the role on /experience. Refined the same day (docs/superpowers/specs/2026-09-06-quiet-cut-design.md): no section numbers or numbered slates, an About scene (paragraph, experience link, three resume figures) sits between the hero and Work, scenes open with a hairline and a serif title, cards are frame, title, one line, one number and a link, no arrow glyphs on links. Wilson found the numbered labels and arrows generic; do not reintroduce them.
